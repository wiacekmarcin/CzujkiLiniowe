...
{
	motorNazwa1 = toQString(settings.value("Silnik-1/Nazwa", QVariant::fromValue(QString("Odbiornik Lewo-Prawo"))).toString());
	motorNazwa2 = toQString(settings.value("Silnik-2/Nazwa", QVariant::fromValue(QString("Odbiornik Gora-Dol"))).toString());
	...
	motorCzasMiedzyImpZerow4 = toUInt(settings.value("Silnik-4/CzasMiedzyImpZerow", QVariant::fromValue(400)).toString());
	motorCzasMiedzyImpZerow5 = toUInt(settings.value("Silnik-5/CzasMiedzyImpZerow", QVariant::fromValue(400)).toString());
	motorCzasMiedzyImpZerow6 = toUInt(settings.value("Silnik-6/CzasMiedzyImpZerow", QVariant::fromValue(1560)).toString());
	motorCzasMiedzyImpZerow7 = toUInt(settings.value("Silnik-7/CzasMiedzyImpZerow", QVariant::fromValue(150)).toString());
	motorCzasMiedzyImpZerow8 = toUInt(settings.value("Silnik-8/CzasMiedzyImpZerow", QVariant::fromValue(4000)).toString());
	motorCzasMiedzyImpZerow9 = toUInt(settings.value("Silnik-9/CzasMiedzyImpZerow", QVariant::fromValue(4000)).toString());
	...
	motorCzasMiedzyImpNormal3 = toUInt(settings.value("Silnik-3/CzasMiedzyImpNormal", QVariant::fromValue(100)).toString());
	motorCzasMiedzyImpNormal4 = toUInt(settings.value("Silnik-4/CzasMiedzyImpNormal", QVariant::fromValue(100)).toString());
	motorCzasMiedzyImpNormal5 = toUInt(settings.value("Silnik-5/CzasMiedzyImpNormal", QVariant::fromValue(100)).toString());
	motorCzasMiedzyImpNormal6 = toUInt(settings.value("Silnik-6/CzasMiedzyImpNormal", QVariant::fromValue(1560)).toString());
	motorCzasMiedzyImpNormal7 = toUInt(settings.value("Silnik-7/CzasMiedzyImpNormal", QVariant::fromValue(150)).toString());
	...
	motorMaksIloscImp9 = toUInt(settings.value("Silnik-9/MaksIloscImp", QVariant::fromValue(1300)).toString());
	motorIloscImpBaza1 = toUInt(settings.value("Silnik-1/IloscImpBaza", QVariant::fromValue(200)).toString());
	motorIloscImpBaza2 = toUInt(settings.value("Silnik-2/IloscImpBaza", QVariant::fromValue(200)).toString());
	motorIloscImpBaza3 = toUInt(settings.value("Silnik-3/IloscImpBaza", QVariant::fromValue(130)).toString());
	motorIloscImpBaza4 = toUInt(settings.value("Silnik-4/IloscImpBaza", QVariant::fromValue(130)).toString());
	motorIloscImpBaza5 = toUInt(settings.value("Silnik-5/IloscImpBaza", QVariant::fromValue(130)).toString());
	...
	motorIloscImpBaza8 = toUInt(settings.value("Silnik-8/IloscImpBaza", QVariant::fromValue(200)).toString());
	motorIloscImpBaza9 = toUInt(settings.value("Silnik-9/IloscImpBaza", QVariant::fromValue(200)).toString());
	motorIloscImpSrodek1 = toUInt(settings.value("Silnik-1/IloscImpSrodek", QVariant::fromValue(700)).toString());
	motorIloscImpSrodek2 = toUInt(settings.value("Silnik-2/IloscImpSrodek", QVariant::fromValue(540)).toString());
	...
	motorIloscImpSrodek8 = toUInt(settings.value("Silnik-8/IloscImpSrodek", QVariant::fromValue(640)).toString());
	motorIloscImpSrodek9 = toUInt(settings.value("Silnik-9/IloscImpSrodek", QVariant::fromValue(540)).toString());
	...
	filtr_db_880_A_1 = toDouble(settings.value("Filtr_db_880_A/Pos1", QVariant::fromValue(0.16)).toString());
	filtr_db_880_B_1 = toDouble(settings.value("Filtr_db_880_B/Pos1", QVariant::fromValue(0.22)).toString());
	filtr_db_880_C_1 = toDouble(settings.value("Filtr_db_880_C/Pos1", QVariant::fromValue(0.99)).toString());
	filtr_db_880_A_2 = toDouble(settings.value("Filtr_db_880_A/Pos2", QVariant::fromValue(0.23)).toString());
	filtr_db_880_B_2 = toDouble(settings.value("Filtr_db_880_B/Pos2", QVariant::fromValue(0.4)).toString());
	filtr_db_880_C_2 = toDouble(settings.value("Filtr_db_880_C/Pos2", QVariant::fromValue(1.94)).toString());
	filtr_db_880_A_3 = toDouble(settings.value("Filtr_db_880_A/Pos3", QVariant::fromValue(0.29)).toString());
	filtr_db_880_B_3 = toDouble(settings.value("Filtr_db_880_B/Pos3", QVariant::fromValue(0.5)).toString());
	filtr_db_880_C_3 = toDouble(settings.value("Filtr_db_880_C/Pos3", QVariant::fromValue(2.96)).toString());
	filtr_db_880_A_4 = toDouble(settings.value("Filtr_db_880_A/Pos4", QVariant::fromValue(0.39)).toString());
	filtr_db_880_B_4 = toDouble(settings.value("Filtr_db_880_B/Pos4", QVariant::fromValue(7.12)).toString());
	filtr_db_880_C_4 = toDouble(settings.value("Filtr_db_880_C/Pos4", QVariant::fromValue(3.95)).toString());
	filtr_db_880_A_5 = toDouble(settings.value("Filtr_db_880_A/Pos5", QVariant::fromValue(6.0)).toString());
	filtr_db_880_B_5 = toDouble(settings.value("Filtr_db_880_B/Pos5", QVariant::fromValue(13.46)).toString());
	filtr_db_880_C_5 = toDouble(settings.value("Filtr_db_880_C/Pos5", QVariant::fromValue(4.81)).toString());
	...
	filtr_db_655_A_1 = toDouble(settings.value("Filtr_db_655_A/Pos1", QVariant::fromValue(1.0)).toString());
	filtr_db_655_B_1 = toDouble(settings.value("Filtr_db_655_B/Pos1", QVariant::fromValue(0.56)).toString());
	filtr_db_655_C_1 = toDouble(settings.value("Filtr_db_655_C/Pos1", QVariant::fromValue(0.44)).toString());
	filtr_db_655_A_2 = toDouble(settings.value("Filtr_db_655_A/Pos2", QVariant::fromValue(0.57)).toString());
	filtr_db_655_B_2 = toDouble(settings.value("Filtr_db_655_B/Pos2", QVariant::fromValue(0.47)).toString());
	filtr_db_655_C_2 = toDouble(settings.value("Filtr_db_655_C/Pos2", QVariant::fromValue(2.48)).toString());
	filtr_db_655_A_3 = toDouble(settings.value("Filtr_db_655_A/Pos3", QVariant::fromValue(2.84)).toString());
	filtr_db_655_B_3 = toDouble(settings.value("Filtr_db_655_B/Pos3", QVariant::fromValue(0.41)).toString());
	filtr_db_655_C_3 = toDouble(settings.value("Filtr_db_655_C/Pos3", QVariant::fromValue(4.13)).toString());
	filtr_db_655_A_4 = toDouble(settings.value("Filtr_db_655_A/Pos4", QVariant::fromValue(0.47)).toString());
	filtr_db_655_B_4 = toDouble(settings.value("Filtr_db_655_B/Pos4", QVariant::fromValue(9.31)).toString());
	filtr_db_655_C_4 = toDouble(settings.value("Filtr_db_655_C/Pos4", QVariant::fromValue(4.41)).toString());
	filtr_db_655_A_5 = toDouble(settings.value("Filtr_db_655_A/Pos5", QVariant::fromValue(7.69)).toString());
	filtr_db_655_B_5 = toDouble(settings.value("Filtr_db_655_B/Pos5", QVariant::fromValue(18.36)).toString());
	filtr_db_655_C_5 = toDouble(settings.value("Filtr_db_655_C/Pos5", QVariant::fromValue(6.22)).toString());
...
{
	return maksRoznicaKatNieWspolOsiowosci;
}
