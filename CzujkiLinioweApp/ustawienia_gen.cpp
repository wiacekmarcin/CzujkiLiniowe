...
void UstawieniaGen::load()
{
    ...
    powtarzalnoscCminCmax = toDouble(settings.value("ParamentryBadania-Powtarzalnosc/CmaxCmin", QVariant::fromValue(1.6)).toString());
}
...
void UstawieniaGen::save()
{
    ...
    settings.setValue("ParamentryBadania-Powtarzalnosc/CmaxCmin", QVariant::fromValue(powtarzalnoscCminCmax));
}
...
{
    return powtarzalnoscCminCmax;
}

void UstawieniaGen::setPowtarzalnoscCminCmax(const double & value)
{
    powtarzalnoscCminCmax = value;
