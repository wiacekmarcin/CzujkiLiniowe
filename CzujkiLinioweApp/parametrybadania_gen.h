...
/********** GET SET **********/
	...
	QString getNazwaNumerPierwszego() const;
	void setNazwaNumerPierwszego(const QString & nazwaNumerPierwszego);
	QString getNazwaNumerDrugiego() const;
	void setNazwaNumerDrugiego(const QString & nazwaNumerDrugiego);
	QString getNazwaPierwszy() const;
	void setNazwaPierwszy(const QString & nazwaPierwszy);
	QString getNazwaDrugi() const;
	void setNazwaDrugi(const QString & nazwaDrugi);
