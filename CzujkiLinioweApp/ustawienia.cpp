...
void Ustawienia::loadListUstawienFiltra()
{
    ...
    if (cntPos == 0) {
        ...
        listaUstawienFiltra655["0.2"] = UkladFiltrow{0,0,1};
        ...
        listaUstawienFiltra655["0.7"] = UkladFiltrow{0,3,1};
        listaUstawienFiltra655["0.8"] = UkladFiltrow{4,3,0};
        listaUstawienFiltra655["0.9"] = UkladFiltrow{4,2,0};
        listaUstawienFiltra655["1.0"] = UkladFiltrow{1,0,0};
        listaUstawienFiltra655["1.2"] = UkladFiltrow{2,1,0};
        listaUstawienFiltra655["1.4"] = UkladFiltrow{1,3,0};
        listaUstawienFiltra655["1.6"] = UkladFiltrow{4,1,1};
        listaUstawienFiltra655["1.8"] = UkladFiltrow{1,3,1};
        listaUstawienFiltra655["2.0"] = UkladFiltrow{1,1,1};
        listaUstawienFiltra655["2.3"] = UkladFiltrow{0,0,2};
        listaUstawienFiltra655["2.6"] = UkladFiltrow{3,0,0};
        listaUstawienFiltra655["2.9"] = UkladFiltrow{0,3,2};
        listaUstawienFiltra655["3.2"] = UkladFiltrow{3,3,0};
        listaUstawienFiltra655["3.5"] = UkladFiltrow{1,0,2};
        listaUstawienFiltra655["3.8"] = UkladFiltrow{1,3,2};
        ...
        listaUstawienFiltra655["7.0"] = UkladFiltrow{4,3,5};
        listaUstawienFiltra655["8.0"] = UkladFiltrow{5,0,1};
        listaUstawienFiltra655["9.0"] = UkladFiltrow{3,0,5};
        listaUstawienFiltra655["10.0"] = UkladFiltrow{5,0,2};
        listaUstawienFiltra655["11.0"] = UkladFiltrow{5,1,1};
        listaUstawienFiltra655["12.0"] = UkladFiltrow{5,0,4};
        listaUstawienFiltra655["13.0"] = UkladFiltrow{1,4,2};
        listaUstawienFiltra655["14.0"] = UkladFiltrow{5,0,5};
        listaUstawienFiltra655["15.0"] = UkladFiltrow{1,4,4};
    } else {
    ...
    if (cntPos == 0) {
        ...
        listaUstawienFiltra880["3.2"] = UkladFiltrow{0,3,1};
        listaUstawienFiltra880["3.5"] = UkladFiltrow{3,1,3};
        listaUstawienFiltra880["3.8"] = UkladFiltrow{4,2,3};
        ...
        listaUstawienFiltra880["6.0"] = UkladFiltrow{5,0,0};
        listaUstawienFiltra880["7.0"] = UkladFiltrow{5,0,1};
        listaUstawienFiltra880["8.0"] = UkladFiltrow{5,0,2};
        listaUstawienFiltra880["9.0"] = UkladFiltrow{5,0,3};
        listaUstawienFiltra880["10.0"] = UkladFiltrow{5,0,4};
        listaUstawienFiltra880["11.0"] = UkladFiltrow{5,1,5};
        listaUstawienFiltra880["12.0"] = UkladFiltrow{0,4,5};
        listaUstawienFiltra880["13.0"] = UkladFiltrow{5,4,0};
        listaUstawienFiltra880["14.0"] = UkladFiltrow{5,4,1};
        listaUstawienFiltra880["15.0"] = UkladFiltrow{5,4,2};
    } else {
        for (short p = 0; p < cntPos; ++p)
        {
