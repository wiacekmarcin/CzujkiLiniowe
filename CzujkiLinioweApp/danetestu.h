...
typedef enum _testId {
    ...
    VIBRATION,
    IMPACT,
    ELECTROMAGNETIC_ELEKTROSTATIC_DISCHARGE,
    ELECTROMAGNETIC_RADIATED_ELEKTROMAGNETIC_FIELDS,
    ELECTROMAGNETIC_CONDUCTED_DISTURBANCE_INDUCED,
    ELECTROMAGNETIC_FAST_TRANSIENT_BURSTS,
    ELECTROMAGNETIC_SLOW_HIGH_ENERGY_VOLTAGE_SURGES,
