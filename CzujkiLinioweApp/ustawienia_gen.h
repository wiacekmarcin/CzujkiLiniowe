...
/********** GET SET **********/
	...
	double getSzybkieZmianyTlumieniaCmaxCmin() const;
	void setSzybkieZmianyTlumieniaCmaxCmin(const double & szybkieZmianyTlumieniaCmaxCmin);
protected:
...
private:
	...
	double szybkieZmianyTlumieniaCmaxCmin;
};
#endif