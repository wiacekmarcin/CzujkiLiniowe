...
u.addValue("float", "sucheCieploCmaxCmin")
u.addValue("float", "zimnoCmaxCmin")
u.addValue("float", "wilgotneCieploOdpornoscCmaxCmin")
u.addValue("float", "wilgotneCieploWytrzymaloscCmaxCmin")
u.addValue("float", "wibracjeCmaxCmin")
u.addValue("float", "uderzenieCmaxCmin")
u.addValue("float", "zakloceniaEMCCmaxCmin")
u.addValue("float", "korozjaSO2CmaxCmin")
